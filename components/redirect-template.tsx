...
export default function RedirectTemplate({ title, description, destination, children }: RedirectTemplateProps) {
  return (
    <>
      <script
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-6 text-center">
          ...
          <p className="text-gray-600">
            ...
            <a href={destination} className="text-green-600 hover:text-green-800 font-medium">
              click here
            </a>
            .
          </p>
