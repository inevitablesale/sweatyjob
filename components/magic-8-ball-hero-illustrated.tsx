...
export default function Magic8BallHeroIllustrated() {
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <div className="flex justify-center my-8 relative">
              {/* Decorative elements to make it clear this is a Magic 8 Ball */}
              <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-white text-black px-6 py-2 rounded-lg font-bold text-lg shadow-lg">
                MAGIC 8 BALL
                <div className="absolute left-1/2 bottom-0 transform -translate-x-1/2 translate-y-1/2 rotate-45 w-4 h-4 bg-white"></div>
              </div>

              {/* Instruction text */}
              <div className="absolute -bottom-12 text-gray-300 text-base">
                Tap to shake and reveal your lawn service's fate
              </div>
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.97 }}
              >
                {/* Main 8 ball sphere with border */}
                <div className="absolute inset-0 rounded-full bg-black border-4 border-gray-800 shadow-[0_0_60px_rgba(0,0,0,0.6)]"></div>

                {/* Blue circle with 8 */}
                <div className="absolute top-5 left-1/2 transform -translate-x-1/2 w-20 h-20 z-10">
                  <div className="w-full h-full bg-blue-600 rounded-full flex items-center justify-center border-4 border-white">
